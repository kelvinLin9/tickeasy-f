...
export default function TicketCheck() {
  const steps = [
    ...
    },
    {
      ...
      title: "便可查看所有電子票券",
      description: "包含「參與的演唱會」、「已結束」、「已退票」",
      images: ["questionDetailContent/checkAllTickets-3.jpg", "questionDetailContent/refundTicket-5.jpg"],
    },
  ];
  ...
  return (
    <div>
      <p className="text-2xl font-bold">我的電子票券在哪裡查看</p>
      <div className="my-8">
